                        ...
                        <tbody>
                            <?php if (!empty($data["pedido"])) : ?>
                                <?php foreach ($data["pedido"] as $pedido) : ?>
                                    <?php if ($pedido["Estado"] === 'EN_PROCESO_VENTA') : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="index.php?c=PedidoController&a=reenviar&id=<?php echo $pedido["ID_Pedido"]; ?>" class="btn btn-danger retornarBtn"><i class="fas fa-arrow-left"></i></a>
                                            </td>
                                        </tr>
                                    <?php endif; ?>
                                <?php endforeach; ?>
...
<script type="text/javascript" src="views/pedido/js/funciones3.js"></script>